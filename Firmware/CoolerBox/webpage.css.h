const char HTTP_STYLE[] PROGMEM = R"V0G0N(
<style>
table {width: 100%;}
...
.values_table {border: 1px solid #DDDDDD;border-spacing:0px; border-top: 0px;margin: 0 auto;}
...
.btn_red{background: #ff0000;border: 0;color: #fff;cursor: pointer;display: inline-block;height: 30px;width: 30px}

.input{width: 60px;text-align: right;}
.inputnum{width: 70px;text-align: right;}
